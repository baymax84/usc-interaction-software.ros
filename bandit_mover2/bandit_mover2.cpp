...
getchar();
 ...
 printf( "size: %d\n", res.name.size() );
  ...
  int win_h = padding*(3+num_sliders)+(num_sliders+1)*slider_h;
 ...
 Fl_Check_Button* checkbutn = new Fl_Check_Button( padding, (i+2)*padding+i*slider_h,slider_w, slider_h, "Enable");
