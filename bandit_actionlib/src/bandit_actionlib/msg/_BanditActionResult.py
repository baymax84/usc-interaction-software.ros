# autogenerated by genmsg_py from BanditActionResult.msg. Do not edit.
...
class BanditActionResult(roslib.message.Message):
  _md5sum = "033995e143bab66fabf42f95f88b4a66"
  _type = "bandit_actionlib/BanditActionResult"
...
"""
  ...
  _slot_types = ['Header','actionlib_msgs/GoalStatus','bandit_actionlib/BanditResult']
  ...
  def __init__(self, *args, **kwds):
    if args or kwds:
      super(BanditActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = bandit_actionlib.msg.BanditResult()
    else:
      self.header = roslib.msg._Header.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = bandit_actionlib.msg.BanditResult()
  ...
  def serialize(self, buff):
    try:
      ...
      buff.write(struct.pack('<i', self.result.total_time))
      #serialize self.result.result_joint_id
      length = len(self.result.result_joint_id)
      buff.write(struct.pack('<I', length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.result.result_joint_id))
      #serialize self.result.result_joint_angle
      length = len(self.result.result_joint_angle)
      buff.write(struct.pack('<I', length))
      pattern = '<%sf'%length
      buff.write(struct.pack(pattern, *self.result.result_joint_angle))
  ...
  def deserialize(self, str):
    try:
      ...
      (self.result.total_time,) = struct.unpack('<i',str[start:end])
      #deserialize self.result.result_joint_id
      start = end
      end += 4
      (length,) = struct.unpack('<I',str[start:end])
      pattern = '<%sf'%length
      ...
      self.result.result_joint_id = struct.unpack(pattern, str[start:end])
      #deserialize self.result.result_joint_angle
      start = end
      end += 4
      (length,) = struct.unpack('<I',str[start:end])
      pattern = '<%sf'%length
      ...
      self.result.result_joint_angle = struct.unpack(pattern, str[start:end])
      return self
  ...
  def serialize_numpy(self, buff, numpy):
    try:
      ...
      buff.write(struct.pack('<I', length))
      pattern = '<%sf'%length
      buff.write(self.result.result_joint_id.tostring())
      #serialize self.result.result_joint_angle
      length = len(self.result.result_joint_angle)
      buff.write(struct.pack('<I', length))
      pattern = '<%sf'%length
      buff.write(self.result.result_joint_angle.tostring())
    except struct.error, se: self._check_types(se)
    except TypeError, te: self._check_types(te)
  ...
  def deserialize_numpy(self, str, numpy):
    try:
      ...
      self.result.result_joint_id = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      #deserialize self.result.result_joint_angle
      start = end
      end += 4
      (length,) = struct.unpack('<I',str[start:end])
      ...
      self.result.result_joint_angle = numpy.frombuffer(str[start:end], dtype=numpy.float32, count=length)
      return self
    except struct.error, e:
      raise roslib.message.DeserializationError(e) #most likely buffer underfill
