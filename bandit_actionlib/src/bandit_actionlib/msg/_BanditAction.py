...
class BanditAction(roslib.message.Message):
  _md5sum = "70b130ecb9b4f74981eaded3a71cfa4e"
...
"""
  ...
  def serialize(self, buff):
    try:
      ...
      buff.write(struct.pack('<i', self.action_result.result.total_time))
      ...
      buff.write(struct.pack('<i', self.action_feedback.feedback.progress_time))
  ...
  def deserialize(self, str):
    try:
      ...
      (self.action_result.result.total_time,) = struct.unpack('<i',str[start:end])
      ...
      (self.action_feedback.feedback.progress_time,) = struct.unpack('<i',str[start:end])
