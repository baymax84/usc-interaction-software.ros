...
class BanditAction(roslib.message.Message):
  _md5sum = "e609497ab0a42efcda7a0c80a8a5e4e4"
...
"""
  ...
  def serialize(self, buff):
    try:
      ...
      buff.write(struct.pack('<f', self.action_feedback.feedback.progress_time))
  ...
  def deserialize(self, str):
    try:
      ...
      (self.action_feedback.feedback.progress_time,) = struct.unpack('<f',str[start:end])
