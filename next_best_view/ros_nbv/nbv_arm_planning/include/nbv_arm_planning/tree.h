...
public:
  typedef struct node {
     ...
     int travel_cost;
     int n_uv;
     OccupancyGrid::array_type* voxel_grid;
     //OccupancyGrid::array_type* occupancy_grid;
  ...
  Tree();
  void newChild(node* parent, int uv, int cost, OccupancyGrid::array_type* vgrid, int index);
  void newChild(node* parent, int uv, int cost, OccupancyGrid::array_type* vgrid, int index, float direction);
  void newChild(node* parent, double expectation, int cost, OccupancyGrid::array_type* vgrid, int index);
  void newChild(node* parent, double expectation, int cost, OccupancyGrid::array_type* vgrid, int index, float direction);
