...
public:
  ...
  // get the arm pose goal
  bool getArmPoseGoal(nbv_utilities::SendCloud::Request &req, nbv_utilities::SendCloud::Response &res);
  ...
  void getTableTop(pcl::PointCloud<Point>::ConstPtr &cloud);
  ...
  geometry_msgs::PoseArray sampling(int i);
...
private:
  ...
  ros::ServiceServer get_arm_pose_goal_srv_;
