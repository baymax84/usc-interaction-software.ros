...
void Tree::newChild(node* parent, int uv, int cost, OccupancyGrid::array_type* vgrid, int index)
{
  node* child = new node;
  child->parent = parent;
  child->n_uv = uv;
...
void Tree::newChild(node* parent, int uv, int cost, OccupancyGrid::array_type* vgrid, int index, float direction)
{
  node* child = new node;
  child->parent = parent;
  child->n_uv = uv;
...
void Tree::newChild(node* parent, double expectation, int cost, OccupancyGrid::array_type* vgrid, int index)
{
  node* child = new node;
  child->parent = parent;
  child->travel_cost = cost + parent->travel_cost;
...
void Tree::newChild(node* parent, double expectation, int cost, OccupancyGrid::array_type* vgrid, int index, float direction)
{
  node* child = new node;
  child->parent = parent;
  child->travel_cost = cost + parent->travel_cost;
...
void Tree::unitTest()
{
  ...
  OccupancyGrid::array_type* vgrid_1 = new OccupancyGrid::array_type;
  newChild(root_, 1.0, 1, vgrid_1, 1);
  OccupancyGrid::array_type* vgrid_2 = new OccupancyGrid::array_type;
  newChild(root_, 2.0, 1, vgrid_2, 2);
  OccupancyGrid::array_type* vgrid_3 = new OccupancyGrid::array_type;
  newChild(root_, 3.0, 1, vgrid_3, 3);

  node* child_1 = root_->child[0];
  OccupancyGrid::array_type* vgrid_4 = new OccupancyGrid::array_type;
  newChild(child_1, 1.1, 1, vgrid_4, 4);
  OccupancyGrid::array_type* vgrid_5 = new OccupancyGrid::array_type;
  newChild(child_1, 1.2, 1, vgrid_5, 5);

  node* child_2 = root_->child[1];
  OccupancyGrid::array_type* vgrid_6 = new OccupancyGrid::array_type;
  newChild(child_2, 2.1, 1, vgrid_6, 6);
  OccupancyGrid::array_type* vgrid_7 = new OccupancyGrid::array_type;
  newChild(child_2, 2.2, 1, vgrid_7, 7);

  node* child_3 = root_->child[2];
  OccupancyGrid::array_type* vgrid_8 = new OccupancyGrid::array_type;
  newChild(child_3, 3.1, 1, vgrid_8, 8);
  OccupancyGrid::array_type* vgrid_9 = new OccupancyGrid::array_type;
