...
// the generic oculesic controller
// this class is designed to function as an adapter between the specified policy and any generic ros-related content
// the oculesic controller publishes a tf frame that represents the point at which the robot should look
...
class OculesicController : public __Policy
{
public:
    template<class... __Args>
    OculesicController( ros::NodeHandle & nh, __Args... args ) : __Policy( nh )
    {
        __Policy::init( args... );
    }
