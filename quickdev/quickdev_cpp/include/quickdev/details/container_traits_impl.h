...
subset_rec<__EndIndex__, __StartIndex__>::exec( __Container && container, __Types&&... types )
{
...
subset_rec<__StartIndex__, __StartIndex__>::exec( __Container && container, __Types&&... types )
{
...
push_back_rec<__EndSize__>::exec( __Container && container, __Types&&... types )
{
...
push_back_rec<1>::exec( __Container && container, __Types&&... types )
{
...
push_front_rec<__EndSize__>::exec( __Container && container, __Type const & type, __Types&&... types )
{
...
push_front_rec<1>::exec( __Container && container, __Type const & type, __Types&&... types )
{
...
combine_rec<__Index__>::exec( __Container1 && container1, __Container2 && container2, __Types&&... types )
{
...
combine_rec<0>::exec( __Container1 && container1, __Container2 && container2, __Types&&... types )
{
    return quickdev::make_container( types... );
}
